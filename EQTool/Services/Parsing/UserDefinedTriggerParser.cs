...
namespace EQTool.Services.Parsing
{
    ...
    { 
        ...
        private bool CreateDefaultTriggerFile(string fileName)
        {
            ...
            fileContents.Add("#");
            fileContents.Add("100;1;Spell Interrupted;^Your spell is interrupted.;1;Spell Interrupted;1;Interrupted");
            fileContents.Add("101;1;Spell Fizzle;^Your spell fizzles!;1;Spell Fizzles;1;Fizzle");
            ...
            fileContents.Add("103;1;Corpse Need Consent;^You do not have consent to summon that corpse;1;Need Consent;1;Need Consent");
            fileContents.Add("104;1;Corpse Out of Range;^The corpse is too far away to summon;1;Corpse OOR;1;Corpse out of range");
            fileContents.Add("105;1;Select a Target;^(You must first select a target for this spell)|(You must first click on the being you wish to attack);1;Select a target;1;Select a target");
            fileContents.Add("106;1;Insufficient Mana;^Insufficient Mana to cast this spell!;1;OOM;1;out of mana");
            fileContents.Add("107;1;Target Out of Range;^Your target is out of range;1;Target out of range;1;Out of range");
            fileContents.Add("108;1;Spell Did Not Take Hold;^Your spell did not take hold;1;Spell did not take hold;1;Spell did not take hold");
            fileContents.Add("109;1;Must be standing to cast;^(You must be standing)|(You are too distracted to cast a spell now);1;Stand up!;1;stand up");
            fileContents.Add("110;1;Dispelled;^You feel a bit dispelled;1;You have been dispelled;1;dispelled");
            fileContents.Add("111;1;Regen Faded;^You have stopped regenerating;1;===== Regen faded =====;1;re-gen faded");
            fileContents.Add("112;1;Can't See Target;^You can't see your target;1;Can't see target;1;Can't see target");
