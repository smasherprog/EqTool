...
namespace EQTool.Services.Map
{
    ...
    {
        public static double ZoneLabelFontSize(AABB aabb) { return MathHelper.ChangeRange(Math.Max(aabb.MaxWidth, aabb.MaxHeight), 500, 35000, 14, 170); }
        public static double OtherLabelFontSize(AABB aabb) { return MathHelper.ChangeRange(Math.Max(aabb.MaxWidth, aabb.MaxHeight), 500, 35000, 6, 110); }
        public static double SmallFontSize(AABB aabb) { return MathHelper.ChangeRange(Math.Max(aabb.MaxWidth, aabb.MaxHeight), 500, 35000, 7, 50); }
        public static double PlayerEllipsesSize(AABB aabb) { return MathHelper.ChangeRange(Math.Max(aabb.MaxWidth, aabb.MaxHeight), 500, 35000, 10, 170); }
        public static double PlayerEllipsesThickness(AABB aabb) { return MathHelper.ChangeRange(Math.Max(aabb.MaxWidth, aabb.MaxHeight), 500, 35000, 3, 24); }
        public static double MapLinethickness(AABB aabb) { return MathHelper.ChangeRange(Math.Max(aabb.MaxWidth, aabb.MaxHeight), 800, 35000, 2, 16); }
        ...
        public static PlayerLocationCircle AddPlayerToCanvas(AddPlayerToCanvasData toCanvasData)
        {
        ...
        public static void AddToCanvas(PlayerLocationCircle playerLocationCircle, Canvas canvas, AABB aabb)
        {
