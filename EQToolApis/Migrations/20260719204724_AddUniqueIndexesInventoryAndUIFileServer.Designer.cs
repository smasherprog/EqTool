...
namespace EQToolApis.Migrations
{
    ...
    [Migration("20260719204724_AddUniqueIndexesInventoryAndUIFileServer")]
    partial class AddUniqueIndexesInventoryAndUIFileServer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EQToolApis.DB.Models.CharacterInventory", b =>
                {
                    b.Property<int>("CharacterInventoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CharacterInventoryId"));
                    ...
                    b.HasIndex("DiscordUserId", "CharacterName", "Server")
                        .IsUnique();

                    b.ToTable("CharacterInventories");
                });

            modelBuilder.Entity("EQToolApis.DB.Models.CharacterInventoryItem", b =>
                {
                    b.Property<int>("CharacterInventoryItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CharacterInventoryItemId"));
                    ...
                    b.HasKey("CharacterInventoryItemId");
            ...
            modelBuilder.Entity("EQToolApis.DB.Models.DiscordUser", b =>
                {
                    b.Property<int>("DiscordUserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EQToolApis.DB.Models.P99WikiByName", b =>
                {
                    b.Property<int>("P99WikiByNameId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("P99WikiByNameId"));
                    ...
                    b.HasKey("P99WikiByNameId");

                    b.HasIndex("Name");

                    b.HasIndex("Name", "ZoneName");

                    b.ToTable("P99WikiByNames");
                });
            ...
            modelBuilder.Entity("EQToolApis.DB.Models.UIFile", b =>
                {
                    b.Property<int>("UIFileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UIFileId"));
                    ...
                    b.HasIndex("DiscordUserId", "FileName", "Server")
                        .IsUnique();
            ...
            modelBuilder.Entity("EQToolApis.DB.Models.CharacterInventory", b =>
                {
                    b.HasOne("EQToolApis.DB.Models.DiscordUser", "DiscordUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EQToolApis.DB.Models.CharacterInventoryItem", b =>
                {
                    b.HasOne("EQToolApis.DB.Models.CharacterInventory", "Inventory")
                        .WithMany("Items")
