...
namespace EQTool.Services.Map
{
    public static class ZoneParser
    {
        ...
        static ZoneParser()
        {
            ...
            NoZoneZHelping.Add("dalnir", false);
            ...
            NoZoneZHelping.Add("erudnint", false);
            ...
            NoZoneZHelping.Add("gukbottom", false);
            NoZoneZHelping.Add("guktop", false);
            ...
            NoZoneZHelping.Add("mischiefplane", false);
            NoZoneZHelping.Add("mistmoore", true);
            NoZoneZHelping.Add("misty", false);
            NoZoneZHelping.Add("najena", false);
            ...
            NoZoneZHelping.Add("paw", false);
            NoZoneZHelping.Add("permafrost", false);
            NoZoneZHelping.Add("qcat", false);
            NoZoneZHelping.Add("qey2hh1", false);
            NoZoneZHelping.Add("qeynos", false);
            NoZoneZHelping.Add("qeynos2", false);
            NoZoneZHelping.Add("qeytoqrg", false);
            NoZoneZHelping.Add("qrg", false);
            NoZoneZHelping.Add("rathemtn", false);
            NoZoneZHelping.Add("rivervale", false);
            NoZoneZHelping.Add("runnyeye", false);
            NoZoneZHelping.Add("sebilis", false);
            NoZoneZHelping.Add("sirens", false);
            NoZoneZHelping.Add("skyfire", false);
            NoZoneZHelping.Add("skyshrine", true);
            NoZoneZHelping.Add("sleeper", false);
            NoZoneZHelping.Add("soldunga", false);
            NoZoneZHelping.Add("soldungb", false);
            NoZoneZHelping.Add("soltemple", false);
