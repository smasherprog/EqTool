...
<ul>
<li>
<h2>Download the latest <a href="https://github.com/smasherprog/EqTool/releases/download/1.0.1.904/EQTool_1.0.1.904.zip">EQTool.zip</a>, Unzip it and run EQTool.exe</h2>
</li>
